...
#define STRING_CONFIG_H_AUTHOR "Will Xie" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bastion"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -7, -0.31 }
